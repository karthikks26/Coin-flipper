...
export const Game = () => {
  ...
  return (
    <>
      ...
      <p>
        Ready to make some money? Enter the amount to bet and pick your side!
        Good luck!
      </p>
      <p
        style={{
      ...
      >
        Note: the result might take up to a few minutes. Just go grab a coffee
        and relax, you will get notified once the flip is over.
      </p>
      <p>
...
const HeadsCoin = () => {
  return (
    <StyledCoin marginRight>
      <img src={EthereumLogo} alt="" width={50} />
    </StyledCoin>
  );
};
